...
consul 不选用本地 exe 的方式应用，现在选用容器方式启动
...
健康检查: https://localhost:445/HealthCheck⁠ ，啊啊，那我大概理解了，此时 其实是 consul 容器内部要去做健康检查访问的地址，而这个地址是 https://localhost:445/HealthCheck⁠， 其实变成了 consul 容器去访问他自己 localhost 了，所以不会成功。
